...
| Changelog source of truth        | `CHANGELOG.md`, generated by release-please from Conventional Commits                                                            |
| Marketplace publishing state     | VS Code Marketplace and Open VSX publishing remain a maintainer step until release secrets are configured                        |
